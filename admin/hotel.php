...
function paginationLinks( $total_pages)
{
...
$query = 'SELECT `HotelID`, `name`, `address`, `NoOfRooms`, `docs` FROM `hotel` ';
$result = mysqli_query($connect, $query);
//Start building query according to input parameters.
// If search string
if ($search_string) {
    // search string name
    $searchQ = "SELECT `HotelID`, `name`, `address`, `NoOfRooms`, `docs` FROM `hotel` WHERE `RoomID` LIKE '$search_string%'";
...
if ($order_by) {
    $orderQ = "SELECT `HotelID`, `name`, `address`, `NoOfRooms`, `docs` FROM `hotel` ORDER BY $filter_col $order_by";
...
<div id="page-wrapper">
        ...
        <tbody>
            <?php foreach ($rows as $row) : ?>
                <tr>
                    ...
                    <td>
                        <a href="edit_hotel.php?hotel_id=<?php echo $row['HotelID']; ?>&operation=edit"
                         class="btn btn-primary"><i class="glyphicon glyphicon-edit"></i></a>
                        <a href="#" class="btn btn-danger delete_btn" data-toggle="modal"
                         data-target="#confirm-delete-<?php echo $row['HotelID']; ?>"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                </tr>
                <div class="modal fade" id="confirm-delete-<?php echo $row['HotelID']; ?>" role="dialog">
                        ...
                        <form action="delete_hotel.php" method="POST">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="del_id" id="del_id" value="<?php echo $row['HotelID']; ?>">
    ...
    <div class="text-center">
        <?php echo paginationLinks( $total_pages); ?>
    </div>
    <!-- //Pagination -->
</div>
<!-- //Main container -->
