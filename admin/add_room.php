...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    $query = "INSERT INTO `room`( `NoOfBeds`, `price`, `typeRoom`) VALUES ('".$data_to_store['NoOfBeds']."','".$data_to_store['price']."','".$data_to_store['typeRoom']."')";
...
<div class="row">
    ...
    <form class="form" action="" method="post"  id="room_form" enctype="multipart/form-data">
       <?php  include_once('./forms/room_form.php'); ?>
    </form>
</div>
